                ...
                <div class="login-content" style="min-width: 100%;background-color:#DEDCDC;">
                    <div class="form-group">
                        <div class="col-sm-6 col-md-6 col-lg-12">
                            ...
                            <input name="sname" data-minlength="6"  type="text" class="form-control ml-24"  value="<%=(String) session.getAttribute("sname")%>" readonly="" aria-describedby="basic-addon1">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-6 col-md-6 col-lg-12">
                    ...
                    <div class="form-group">
                        <div class="col-sm-6 col-md-6 col-lg-12">
                            ...
                            <input class="btn btn-info" value="CHANGE" name="signin" type="submit">
                        </div>
                    </div>
