...
<body class="login">
    ...
    <%
        try {
           ...
           ////out.println(subName+" "+quesSet+" "+quesLevel+" "+totalDuration+" "+totalMarks+" "+totalQuestion+" "+email+" "+sname);
            ...
            //out.println("size of selectedList ="+selectedList.size());
            //out.println("old selectedList = "+selectedList);
            String options="";
            int nullCount=0;
            ...
            //out.println("Hello"); 
            //out.println("New selectedList = "+selectedList);   
             session.setAttribute("selectedList",selectedList);
             //out.println("Answer List = "+answerList);   
             //out.println("legth of selected list is= "+selectedList.size()+"<br>");
             //out.println("legth of answer list is= "+answerList.size()+"<br>");
            for (int i = 0; i < answerList.size(); i++) {
                System.out.println("Selected answer is" + selectedList.get(i));
                if (answerList.get(i).equals(selectedList.get(i))) {
                    count = count + 1;
                }
                else{
                    count=count+0;
