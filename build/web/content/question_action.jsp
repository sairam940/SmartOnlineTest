                    ...
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="table_items">
                        ...
                        <tbody id="tbody">
                            ...
                            <tr>
                                ...
                                <td contenteditable="true" id="level"><%=s.getQuesLevel()%></td>
                                <td contenteditable="true" id="name"><%=s.getQuestion()%></td>
                                <td contenteditable="true" id="op1"><%=s.getOption1()%></td>
                                <td contenteditable="true" id="op2"><%=s.getOption2()%></td>
                                <td contenteditable="true" id="op3"><%=s.getOption3()%></td>
                                <td contenteditable="true" id="op4"><%=s.getOption4()%></td>
                                <td contenteditable="true" id="q_set"><%=s.getQuesSet()%></td>
                                <td contenteditable="true" id="ans"><%=s.getAnswer()%></td>
