                ...
                <div class="container-fluid">
                    <div class="inner-block">
                        ...
                        <table id="myTable" class="display test-grid">
                            ...
                            <%   
                            List<Faculty_Student> al = Faculty_StudentModel.getSubjects(semail);
                            if(al.size()!=0)
                            {
                                for (Faculty_Student s : al) {
                            %>
                            <tr>
                                <td id="name">
                                    <span id="sub_name"><%=s.getSubject()%></span>
                                    <p>
                            ...
                            {
                                out.println("<tr><td id='name'><center><h4>No Subject available for test.</h4></center></td></tr>");
                            }
                            %>
                        </table>
                    </div>
