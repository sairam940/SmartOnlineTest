...
<html lang="en">
    <head>
        ...
        <div class="col-sm-12">
            ...
            <form action="FacultyController" method="POST" id="login-form">
                <div class="login-content" style="min-width: 100%;background-color:#DEDCDC;">
                    ...
                    <div class="input-group input-blue">
                        ...
                        <input name="email" type="email" required title=" Enter email" class="form-control ml-24" placeholder="Email..." aria-describedby="basic-addon1">
                    </div>
                    <label class="form-label">
                        Password:
                    </label>
                    ...
                    <a href="faculty-forgot" class="pull-right fgt-link">Forgotten password?</a>
                </div>
            </form>
        </div>
</div>
