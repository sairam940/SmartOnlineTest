...
<jsp:include page="footer.jsp" ></jsp:include>
            ...
            <%
                ...
                out.println("<div class='container'><h1 style='color:red;'><center>you have already given this exam.</center></h1></div><br>");
                ...
                //out.println("<input class='btn-primary about-image' onclick='window.location.href = 'tests';' type='submit' value='Proceed'>");
                //out.println("&nbsp;&nbsp;<input class='btn-primary about-image' onclick='window.location.href = 'profile';' type='submit' value='Edit Profile'>");
